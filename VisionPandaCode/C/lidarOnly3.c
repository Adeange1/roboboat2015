...
#define S_FUNCTION_NAME lidarOnly3
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
//mex lidarOnly3.c urg_ctrl.c ring_buffer.c scip_handler.c serial_ctrl.c serial_utils.c urg_delay.c urg_errno.c urg_ticks.c
