/*
 *   rgbtohsv_int_sfun.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        void rgbtohsv_wrapper_int(uint8 y1[480][640][3], uint8 u1[][][])
 *
 *   Simulink version           : 7.3 (R2009a) 15-Jan-2009
 *   C source code generated on : 03-Jul-2014 14:18:36
 ...
 */
#define S_FUNCTION_NAME                rgbtohsv_int_sfun
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S)) {
     ...
     */
    ssRegMdlInfo(S, "rgbtohsv_wrapper_int", MDL_INFO_ID_RESERVED, 0, 0, (void*)
                 ssGetPath(S));
  }
