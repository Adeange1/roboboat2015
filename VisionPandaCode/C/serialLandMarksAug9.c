 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Sat Aug  9 23:05:28 2014
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME serialLandMarksAug9
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void serialLandMarksAug9_Outputs_wrapper(const int32_T *distance,
                          const int32_T *angle,
                          const int32_T *color,
                          const real_T *prob,
                          const int32_T *idx,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    const int32_T   *distance  = (const int32_T*) ssGetInputPortSignal(S,0);
    const int32_T   *angle  = (const int32_T*) ssGetInputPortSignal(S,1);
    const int32_T   *color  = (const int32_T*) ssGetInputPortSignal(S,2);
    const real_T   *prob  = (const real_T*) ssGetInputPortSignal(S,3);
    const int32_T   *idx  = (const int32_T*) ssGetInputPortSignal(S,4);
    ...
    sprintf(sendBuffer,"A:%d B:%d C:%d D:%d E:%d F:%d G:%d H:%d I:%d J:%d K:%d L:%d M:%d N:%d O:%d P:%d Q:%d R:%d S:%d T:%d U:%d V:%d W:%d X:%d C1:%d C2:%d C3:%d C4:%d P1:%g P2:%g P3:%g P4:%g I1:%d I2:%d I3:%d I4:%d \r\n",
