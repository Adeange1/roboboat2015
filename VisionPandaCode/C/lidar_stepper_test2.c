 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Tue Jun 17 14:04:49 2014
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME lidar_stepper_test2
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
//mex -I"C:\Program Files\Phidgets" -L"C:\Program Files\Phidgets" -lphidget21 lidar_stepper_test2.c urg_ctrl.c ring_buffer.c scip_handler.c serial_ctrl.c serial_utils.c urg_delay.c urg_errno.c urg_ticks.c
...
extern void lidar_stepper_test_Outputs_wrapper(const real_T *Speed,
                          const real_T *Upos,
                          const real_T *Dpos,
                          real_T *lidarData);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    //lidar_stepper_test_Outputs_wrapper(Speed, Upos, Dpos, lidarData);
}
