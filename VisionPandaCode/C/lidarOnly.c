...
#define S_FUNCTION_NAME lidarOnly
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
//mex lidarOnly.c urg_ctrl.c ring_buffer.c scip_handler.c serial_ctrl.c serial_utils.c urg_delay.c urg_errno.c urg_ticks.c
