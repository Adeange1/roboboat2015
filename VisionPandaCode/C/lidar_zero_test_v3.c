 ...
 *
 *  Ensure that the zero position of the pot before using this code
 *
 */

/*
 * File: lidar_zero_test_v2.c
 *
 *
  *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Fri Jun 20 09:05:33 2014
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME lidar_zero_test_v3
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void lidar_zero_test_Outputs_wrapper(const int32_T *potVal,
                          const real_T *Speed,
                          const real_T *Upos,
                          const real_T *Dpos,
                          real_T *lidarData);
