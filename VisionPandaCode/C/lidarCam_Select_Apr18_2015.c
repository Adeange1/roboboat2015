...
static void mdlOutputs(SimStruct *S, int_T tid) {
    ...
    int zeroPos = 196; //Potentiometer reading at level position
    int stepRes = 7328; //Number of steps to move the gimbal 180 degrees
    int potRes = 462; //Number of potValues that represent the rotation of the gimbal 180 degrees
