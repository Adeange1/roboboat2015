 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Mon Jun 23 13:16:50 2014
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME videoExport_v2
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void videoExport_v2_Outputs_wrapper(const uint8_T *Red,
                          const uint8_T *Green,
                          const uint8_T *Blue);
...
*/
    ...
    //videoExport_v2_Outputs_wrapper(Red, Green, Blue);
}
