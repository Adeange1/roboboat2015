 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Fri Apr 11 09:41:50 2014
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME Lidar
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
//extern void Lidar_Outputs_wrapper(real_T *y0);
...
#define MDL_START  /* Change to #undef to remove function */
  ...
  {
    fd = open/t("/dev/ttyACM0", O_RDWR | O_NOCTTY | O_NDELAY); //ttyACM0 for lidar
    if (fd == -1) {
