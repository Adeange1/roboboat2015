 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Sat Jul  5 10:49:21 2014
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME dist_imExportV2
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void dist_imExport_Outputs_wrapper(const real_T *dist_im);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    /*dist_imExport_Outputs_wrapper(dist_im);*/
}
