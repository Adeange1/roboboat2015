 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Tue Jul 22 19:41:15 2014
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME lcm_logger_save
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void lcm_logger_save_Outputs_wrapper(const real_T *pose_data,
...
#define MDL_START  /* Change to #undef to remove function */
  ...
  static void mdlStart(SimStruct *S)
  {
    ...
    sprintf(namestr,"lcmlog:%s",ctime(&currTime)); 
