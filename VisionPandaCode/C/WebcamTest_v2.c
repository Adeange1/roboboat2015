...
#define S_FUNCTION_NAME WebcamTest_v2
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
*/
    ...
    for(i = 0; i < OUTPUT_0_WIDTH*OUTPUT_DIMS_0_COL*3; i+=3){
        ...
        Blue[j*OUTPUT_0_WIDTH+k] = data1[i];
        Green[j*OUTPUT_0_WIDTH+k] = data1[i+1];
        Red[j*OUTPUT_0_WIDTH+k] = data1[i+2];
        j++;
