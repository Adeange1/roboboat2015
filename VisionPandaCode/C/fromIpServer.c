 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Mon Jul 20 11:06:27 2009
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME fromIpServer
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void fromIpServer_Outputs_wrapper(const int16_T *u0,
                          int16_T *y0);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    fromIpServer_Outputs_wrapper(u0, y0);
}
