...
#define S_FUNCTION_NAME lidar_stepper_test
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
//mex -I"C:\Program Files\Phidgets" -L"C:\Program Files\Phidgets" -lphidget21 lidar_stepper_test.c urg_ctrl.c ring_buffer.c scip_handler.c serial_ctrl.c serial_utils.c urg_delay.c urg_errno.c urg_ticks.c
