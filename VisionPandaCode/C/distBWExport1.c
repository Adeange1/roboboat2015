 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Sat Jul  5 23:47:02 2014
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME distBWExport1
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void distBWExport_Outputs_wrapper(const boolean_T *dist_im);
...
{
    const boolean_T   *dist_im  = (const boolean_T*) ssGetInputPortSignal(S,0);
    ...
    //distBWExport_Outputs_wrapper(dist_im);
}
