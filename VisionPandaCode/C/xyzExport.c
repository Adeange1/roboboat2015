 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Tue Jul  8 11:43:35 2014
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME xyzExport
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void xyzExport_Outputs_wrapper(const real_T *x,
                          const real_T *y,
                          const real_T *z);
...
#define MDL_START  /* Change to #undef to remove function */
  ...
  static void mdlStart(SimStruct *S)
  {
    ...
    if(fdX == NULL){
        printf("X File Not Opened\n");
        exit(1);
    }
    if(fdY == NULL){
        printf("Y File Not Opened\n"); 
        exit(1); 
    }
    if(fdZ == NULL){
        printf("Z File Not Opened\n");
        exit(1); 
    }
