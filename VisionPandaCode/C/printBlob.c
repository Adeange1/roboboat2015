 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Mon Jul  7 23:17:40 2014
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME printBlob
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
#include "simstruc.h"
#include <stdio.h> 
extern void printBlob_Outputs_wrapper(const uint32_T *blob);
...
{
    const uint32_T   *blob  = (const uint32_T*) ssGetInputPortSignal(S,0);
    ...
    //printBlob_Outputs_wrapper(blob);
}
