 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Wed Jul  2 01:34:31 2014
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME lv_Export
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Input Port  3 */
#define IN_PORT_3_NAME      lidar
#define INPUT_3_WIDTH       70200
...
extern void lv_Export_Outputs_wrapper(const uint8_T *Red,
                          const uint8_T *Green,
                          const uint8_T *Blue,
                          const real_T *lidar);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T   *lidar  = (const real_T*) ssGetInputPortSignal(S,3);
    ...
    //lv_Export_Outputs_wrapper(Red, Green, Blue, lidar);
}
