 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Tue Jul 22 17:03:01 2014
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME lcmPrinter
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
#include "simstruc.h"
#include <stdio.h> 
extern void lcmPrinter_Outputs_wrapper(const real_T *pose,
                          const real_T *vel,
                          const real_T *euler,
